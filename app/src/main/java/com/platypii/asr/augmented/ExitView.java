...
public class ExitView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(currentLocation != null) {
            ...
            // Iterate over towers
            final List<Place> places = GeoQuery.getNeighbors(currentLocation);
            if(places != null) {
                for (Place place : places) {
                    tempLocation.setLatitude(place.latitude);
                    tempLocation.setLongitude(place.longitude);
                    tempLocation.setAltitude(place.altitude);
                    drawTower(canvas, tempLocation, "");
                }
            }
        }
    }
